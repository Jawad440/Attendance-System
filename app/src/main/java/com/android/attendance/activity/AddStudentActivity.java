...
public class AddStudentActivity extends Activity {
	...
	private final String[] semesterString = new String[] {"1","2","3","4","5","6","7","8"};
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		spinnersemester=(Spinner) findViewById(R.id.spinnersemesters);
		...
		ArrayAdapter<String> adapter_semester = new ArrayAdapter<>(this,
		...
		registerButton.setOnClickListener(v -> {
			...
			if (TextUtils.isEmpty(first_name)) {
				...
				studentBean.setStudent_semester(semester);
