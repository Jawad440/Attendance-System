...
public class AddAttandanceSessionActivity extends Activity {
	...
	private final String[] subjectFinal = new String[] {"Software Engineering","Operating System","Web Design","Networking","Data Structure","OOP"};
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		...
		/*ArrayAdapter<String> adapter_semester = new ArrayAdapter<String>(this, android.R.layout.simple_spinner_item, semesterString);
