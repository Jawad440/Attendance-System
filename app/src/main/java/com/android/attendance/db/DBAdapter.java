...
public class DBAdapter extends SQLiteOpenHelper {
	...
	public void addStudent(StudentBean studentBean) {
		...
		String query = "INSERT INTO student_table (student_firstname,student_lastname,student_mobilenumber,student_address,student_department,student_class,student_semester) values ('"+
				...
				studentBean.getStudent_semester() +"')";
		Log.d("query", query);
		db.execSQL(query);
		db.close();
	}
	...
	public ArrayList<StudentBean> getAllStudent()
	{
		...
		if(cursor.moveToFirst()) 
		{
			do{
				...
				studentBean.setStudent_semester(cursor.getString(7));
